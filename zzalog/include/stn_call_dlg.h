...
public:
    ...
    //! \param H height
    //! \param L label
    stn_call_widget(int X, int Y, int W, int H, const char* L = nullptr);
...
//! Class  provides a container to hold several stn_call_widget items
class stn_call_cntnr :
    public Fl_Scroll
{
public:
    //! Constructor 
    ...
    //! \param H height
    //! \param L label
    stn_call_cntnr(int X, int Y, int W, int H, const char* L = "");

    //! Destructor
    ~stn_call_cntnr();

    //! Get selected widget
    stn_call_widget* value();
...
protected:
    ...
    //! Contained widgets
    std::map<std::string, stn_call_widget*> widgets_;
...
//! \brief This class provides the call pane of the stn_dialog
class stn_call_dlg :
    public Fl_Group
{
public:
    ...
    //! \param H height
    //! \param L label
    stn_call_dlg(int X, int Y, int W, int H, const char* L);
...
protected:
    ...
    std::string new_callsign_;       //!< New location entered
    std::string callsign_;          //!< Current selected location
};
