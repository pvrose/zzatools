...
class record;
	...
	public:
		...
		//! See xml_reader::start_element for API details.
		...
		//! See xml_reader::end_element for API details.
		...
		//! characters - characters are stored for use in the end_element method. Any singleton
