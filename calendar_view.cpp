...
calendar_view::calendar_view(int X, int Y, int W, int H, tm date) :
...
void calendar_view::draw_cell(TableContext context, int R, int C, int X, int Y,
	int W, int H) {
...
tm& calendar_view::value() {
	return selected_date_;
}

// Set the value
void calendar_view::value(tm date) {
...
tm* calendar_view::get_date(int R, int C) {
