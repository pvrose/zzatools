...
void qso_data::create_form(int X, int Y) {
	...
	max_x = std::max<int>(max_x, g_entry_->x() + g_entry_->w());
	max_y = std::max<int>(max_y, g_entry_->y() + g_entry_->h());
	// Multiple QSO entry
	...
	max_x = std::max<int>(max_x, g_net_entry_->x() + g_net_entry_->w());
	max_y = std::max<int>(max_y, g_net_entry_->y() + g_net_entry_->h());

	// Query form
	g_query_ = new qso_query(curr_x, curr_y, g_net_entry_->w(), g_net_entry_->h());

	max_x = std::max<int>(max_x, g_query_->x() + g_query_->w());
	max_y = std::max<int>(max_y, g_query_->y() + g_query_->h());
	...
	max_x = std::max<int>(max_x, g_qy_entry_->x() + g_qy_entry_->w());
	max_y = std::max<int>(max_y, g_qy_entry_->y() + g_qy_entry_->h());
	...
	max_x = std::max<int>(max_x, g_misc_->x() + g_misc_->w());
	...
	max_x = std::max<int>(max_x, g_buttons_->x() + g_buttons_->w());
	max_x += GAP;
